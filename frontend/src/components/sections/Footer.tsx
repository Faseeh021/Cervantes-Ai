...
export function Footer() {
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-[1440px] mx-auto px-[77px]">
        <div className="flex justify-between">
          ...
          <div className="animate-on-scroll">
            ...
            >
              Create smarter content with Cervantes AI —<br />
              generate, automate, and scale everything<br />
            ...
            <ul className="space-y-[18px]">
              {menuLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="font-plus-jakarta footer-link"
                    style={{ fontSize: "16px", fontWeight: 400, lineHeight: "100%", color: "#4A4A4A" }}
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="animate-on-scroll" style={{ transitionDelay: "0.2s" }}>
            ...
            <ul className="space-y-[18px]">
              <li className="flex items-center gap-3">
                ...
                <span className="font-plus-jakarta" style={{ fontSize: "16px", fontWeight: 400, color: "#4A4A4A" }}>
                  +1 (800) 123-4567
                </span>
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-start gap-3">
                {/* Location - outlined */}
                <svg width="16" height="20" viewBox="0 0 16 20" fill="none" className="mt-0.5">
                ...
                <span className="font-plus-jakarta" style={{ fontSize: "16px", fontWeight: 400, color: "#4A4A4A", lineHeight: "150%" }}>
                  Remote-first company, serving<br />sellers worldwide
                </span>
              </li>
            </ul>
          </div>
      ...
      {/* Footer Background Image - already faded in source */}
