...
export function DashboardShowcase() {
  return (
    ...
    >
      ...
      <div
        className="absolute left-0 lg:-left-[60px] xl:-left-[100px] top-0 bottom-0 w-[60px] sm:w-[80px] lg:w-[150px] xl:w-[250px] pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 100% 60% at 0% 50%, rgba(180, 130, 255, 0.5) 0%, rgba(160, 100, 240, 0.25) 40%, transparent 70%)",
        }}
      />

      {/* Right purple glow effect - visible on all screens */}
      <div
        className="absolute right-0 lg:-right-[60px] xl:-right-[100px] top-0 bottom-0 w-[60px] sm:w-[80px] lg:w-[150px] xl:w-[250px] pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 100% 60% at 100% 50%, rgba(180, 130, 255, 0.5) 0%, rgba(160, 100, 240, 0.25) 40%, transparent 70%)",
        }}
      />

      {/* Large Dashboard Image Container with glow */}
      <div className="relative w-[94%] sm:w-[96%] max-w-[1302px] dashboard-glow">
        <Image
          ...
          height={745}
          priority
          className="w-full h-auto rounded-[8px] sm:rounded-[12px] lg:rounded-[20px] object-cover shadow-2xl"
        />

        {/* White fade overlay at bottom */}
        <div
          className="absolute bottom-0 left-0 right-0 h-[30px] sm:h-[50px] lg:h-[80px] rounded-b-[8px] sm:rounded-b-[12px] lg:rounded-b-[20px] pointer-events-none"
          style={{
            background:
